...
{
    /// <inheritdoc />
    public partial class Trip_TripActivity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Settings_Description = table.Column<string>(type: "text", nullable: false),
                    Settings_Budget = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
